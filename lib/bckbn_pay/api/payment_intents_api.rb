...
module BckbnPay
  class PaymentIntentsApi
    ...
    # @param x_api_version [String] 
    # @param payment_intent_attributes [PaymentIntentAttributes] 
    # @param [Hash] opts the optional parameters
    # @return [PaymentIntentResponse]
    def create_payment_intent(x_api_version, payment_intent_attributes, opts = {})
      data, _status_code, _headers = create_payment_intent_with_http_info(x_api_version, payment_intent_attributes, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(PaymentIntentResponse, Integer, Hash)>] PaymentIntentResponse data, response status code and response headers
    def create_payment_intent_with_http_info(x_api_version, payment_intent_attributes, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'payment_intent_attributes' is set
      if @api_client.config.client_side_validation && payment_intent_attributes.nil?
        fail ArgumentError, "Missing the required parameter 'payment_intent_attributes' when calling PaymentIntentsApi.create_payment_intent"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(payment_intent_attributes)
    ...
    # @param update_payment_intent_request [UpdatePaymentIntentRequest] 
    # @param [Hash] opts the optional parameters
    # @return [PaymentIntentResponse]
    def update_payment_intent(x_api_version, id, update_payment_intent_request, opts = {})
      data, _status_code, _headers = update_payment_intent_with_http_info(x_api_version, id, update_payment_intent_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(PaymentIntentResponse, Integer, Hash)>] PaymentIntentResponse data, response status code and response headers
    def update_payment_intent_with_http_info(x_api_version, id, update_payment_intent_request, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && update_payment_intent_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_payment_intent_request' when calling PaymentIntentsApi.update_payment_intent"
      end
      # resource path
      local_var_path = '/payment_intents/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_payment_intent_request)
