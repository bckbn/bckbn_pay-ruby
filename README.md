...
*BckbnPay::PaymentIntentsApi* | [**update_payment_intent**](docs/PaymentIntentsApi.md#update_payment_intent) | **POST** /payment_intents/{id} | Update a payment intent
...
## Documentation for Models
 ...
 - [BckbnPay::UpdatePaymentIntentRequest](docs/UpdatePaymentIntentRequest.md)
